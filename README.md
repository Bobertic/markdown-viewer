...
1. [**Открыть страницу**](https://bobertic.github.io/markdown-viewer/)
2. **Загрузить файл** – нажмите «Выберите Markdown файл» и укажите `.md` или `.txt`.
3. **Вставить ссылку** – введите raw‑ссылку (например, `https://raw.githubusercontent.com/.../README.md`) и нажмите «Загрузить».
4. **Пример** – кнопка «✨ Пример с GitHub» загрузит демонстрационный файл.
5. **Очистить** – кнопка «🗑️ Очистить» сбрасывает просмотр.
